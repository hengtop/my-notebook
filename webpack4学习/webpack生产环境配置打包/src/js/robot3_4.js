  ...
  data: {
    ...
    created() {
      if(window.location.search.split('=')[1] == 5) {
        this.allVideoList = this.allVideoList.slice(0,5);
      }
    },
  mounted() {
    this.init();
